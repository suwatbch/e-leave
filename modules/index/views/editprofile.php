...
class View extends \Gcms\View
{
    ...
    public function render(Request $request, $user, $login)
    {
        ...
        $groups->add('select', array(
            ...
            'itemClass' => 'width50',
            'label' => '{LNG_Work shift}<em>*</em>',
            'options' => \Eleave\Leavetype\Model::getshifttype()->toshifttype(), // ใช้ toshifttype() ที่ปรับปรุงแล้ว
            'disabled' => $isAdmin ? false : true,
            'value' => $user['shift_id']
        ));
        ...
        if ($isAdmin) {
            ...
            $groups->add('text', array(
                ...
                'itemClass' => 'width50',
                'maxlength' => 8,
                'label' => '{LNG_First approver}<em>*</em>',
                'placeholder' => '{LNG_Enter 8-digit employee code}',
                'disabled' => $isAdmin ? false : true,
                'value' => $user['m1']
            ));
            // ผู้อนุมัติ M2
        ...
        if ($isAdmin) {
            $fieldset = $form->add('fieldset', array(
                'title' => '{LNG_Quota of leave}'
            ));
            $year = date('Y');
            $years = \Gcms\Functions::selectyear3($year);
            // status
            ...
            $groups->add('text', array(
                ...
                'labelClass' => 'g-input icon-number',
                'itemClass' => 'width30',
                'label' => '{LNG_Business leave}<em>*</em>',
            ...
            $groups->add('text', array(
                ...
                'labelClass' => 'g-input icon-number',
                'itemClass' => 'width30',
                'label' => '{LNG_Maternity leave}<em>*</em>',
            ...
            $groups->add('text', array(
                ...
                'labelClass' => 'g-input icon-number',
                'itemClass' => 'width30',
                'label' => '{LNG_Leave for military service}<em>*</em>',
            ...
            $groups->add('text', array(
                ...
                'labelClass' => 'g-input icon-number',
                'itemClass' => 'width30',
                'label' => '{LNG_Ordination leave}<em>*</em>',
