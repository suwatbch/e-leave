    ...
    public function preSend()
    {
        try {
            ...
            if ((count($this->to) + count($this->cc) + count($this->bcc)) < 1) {
                throw new phpmailerException($this->lang(Language::get('You must provide at least one recipient email address')), self::STOP_CRITICAL);
                // throw new phpmailerException($this->lang(Language::get('provide_address')), self::STOP_CRITICAL);
            }
